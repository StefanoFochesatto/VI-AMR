...
The dome problem was solved with 13 levels of refinement from an initial mesh uniform with $h_0=360$ kilometers, giving a final margin resolution of $h_{13}=31$ meters.  Figure FIXME compares the solution error norm $\|u-u_h\|_{\cX}$ and the maximum $\|H-H_h\|_\infty$ and average $L^{-2} \|H-H_h\|_1$ thickness error norms versus number of elements.
