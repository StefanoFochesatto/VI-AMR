...
\Cbotu = \{x\,:\,u(x) = \lb(x)\} \quad \text{ and } \quad \Ctopu = \{x\,:\,u(x) = \ub(x)\}
\end{equation}
for the \emph{lower-} and \emph{upper-contact} (active) subsets of $\Omega$; they are disjoint by the compatibility conditions \eqref{eq:compat}.  Let $E_u = \Omega \setminus (\Cbotu \cup \Ctopu)$ be the open \emph{inactive} set.
