...
The dome problem was solved with 13 levels of refinement from an initial uniform mesh with $h_0=360$ kilometer elements, to a refined mesh with a final margin resolution of $h_{13}\approx 30$ meters.  Figure \ref{fig:domeresults} shows error norms $\|u-u_h\|_{\cX}/\|u\|_{\cX}$ and $\|H-H_h\|_{L^\infty}/\|H\|_{L^\infty}$, versus number of elements.
