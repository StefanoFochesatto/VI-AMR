...
\caption{Meshes computed from the UDO (left), VCD (middle), and AVM (right) methods, on the obstacle problem shown in Figure \ref{fig:ball} and middle of Figure \ref{fig:activesizes}.}
