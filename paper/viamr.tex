...
\caption{Left:  A one-dimensional obstacle problem with a parabolic obstacle, for which the exact free boundary location $x_*$ is known.  Right:  Using uniform meshes, the geometrical error $\Delta_h$ in locating $x_*$ explains the erratic error norm $\|u-u_h\|$ reduction.}
\label{fig:parabola}
\end{figure}
