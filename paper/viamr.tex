...
\begin{enumerate}
\item The unstructured diffusion operator (UDO) method discretely identifies elements adjacent to the computed free boundary, employing a graph-based approach to tag neighboring elements for refinement.  It generalizes the bitmap image processing operation of dilation \cite{Pratt1991} to unstructured meshes.
...
FIXME compare \cite{Suttmeier2008} re DWR, and \cite{AinsworthOdenLee1993} re subtle BR analog
