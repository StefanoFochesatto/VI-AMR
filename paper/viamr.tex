...
\begin{figure}[ht]
\noindent\mbox{\includegraphics[width=0.49\textwidth]{genfigs/convball_UDO+BR.png} \, \includegraphics[width=0.49\textwidth]{genfigs/jaccball.png}}
\caption{For the ball example.  Left: $L^2$ norm errors for the UDO$+$BR method, and uniform refinement.  Right: Active set Jaccard distances.}
\label{fig:ballconv}
\end{figure}
