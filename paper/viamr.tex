...
FIXME: As described, D is a vector with DG0 dimension, however the diffusion problem is solved in CG1. What is actually happening is that h = Function(CG1).project(cellDiameter). 
