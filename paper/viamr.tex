...
\end{equation}
the numerical inactive and active sets, respectively, defined a posteriori from the solution to \eqref{eq:fe:vi}; compare \eqref{eq:classical:sets}.
