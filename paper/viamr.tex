...
\subsection{Mesh quality and performance} \label{subsec:performance}  FIXME  To demonstrate the use of the Jaccard index, and the effectiveness of our proposed methods we consider two particular problems. 
